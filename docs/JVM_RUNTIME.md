...
to provide Java 8-compatible JAR artifacts.
...
- `Vendor/OpenJDK`: pinned, locally bootstrapped OpenJDK 8 Zero iOS runtime.
...
The Java compiler is explicitly limited to Java 8 bytecode. The runtime also
validates every `.class` file in a loaded extension and rejects versions newer
than Java 8 (class-file major version 52).

## Compatibility scope

The next layer will provide the Android and Mihon APIs commonly used by
